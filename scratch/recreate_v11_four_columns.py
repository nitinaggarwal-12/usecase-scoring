...
four_columns_code = """import { useState, useMemo, useEffect, useRef, useCallback } from 'react';
import { 
...
export const V11_PILLARS = [
  {
    id: 'UX_HITL',
    name: 'User Experience & HITL Workflow',
    weight: 20,
    persona: 'Business',
                ...
                >
                  <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', overflow: 'hidden' }}>
                    ...
                    <span style={{ fontSize: '0.74rem', fontWeight: isActive ? 800 : 550, color: isActive ? colors.textDark : colors.textMuted, whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>
                      {idx === 0 ? 'Strategic Value' : idx === 1 ? 'Data Readiness' : idx === 2 ? 'Architecture' : idx === 3 ? 'Security, Gov...' : 'Execution, Eval...'}
                    </span>
                  </div>
...
with open(file_path, 'w', encoding='utf-8') as f:
    f.write(four_columns_code)

print("PremiumScopingAssessorV11 has been successfully recreated to match the light-themed 4-column layout exactly!")

...
ultimate_code = """import React, { useState, useMemo, useEffect, useRef } from 'react';
...
export default function PremiumScopingAssessorV12({ onBackToLanding, globalTheme = 'dark', apiKey = '', gcpToken = '' }) {
  ...
  const financialMetrics = useMemo(() => {
    ...
    // OpEx calculations
    const softwareLicense = buyVsBuildSelection === 'buy' ? 120000 : 0; // Managed platform license
    const modelCompute = buyVsBuildSelection === 'buy' ? 320000 : 80000; // AWS Bedrock vs Google Gemini dynamic token cost
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '0.85rem', flex: 1 }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '0.65rem' }}>
                  ...
                  <div className="v12-card-glass" style={{ display: 'flex', alignItems: 'center', gap: '0.8rem', background: '#0e1428' }}>
                    ...
                    <div>
                      <span style={{ fontSize: '0.56rem', color: '#9ca3af', fontWeight: 800, textTransform: 'uppercase', display: 'block' }}>Financials (3-Year TCO)</span>
                  ...
                  <div className="v12-card-glass" style={{ display: 'flex', alignItems: 'center', gap: '0.8rem', background: '#0e1428' }}>
                    ...
                    <div>
                      <span style={{ fontSize: '0.56rem', color: '#9ca3af', fontWeight: 800, textTransform: 'uppercase', display: 'block' }}>Time-to-Value & Validation</span>
                  ...
                  <div className="v12-card-glass" style={{ display: 'flex', alignItems: 'center', gap: '0.8rem', background: '#0e1428' }}>
                    ...
                    <div>
                      <span style={{ fontSize: '0.56rem', color: '#9ca3af', fontWeight: 800, textTransform: 'uppercase', display: 'block' }}>Enterprise Scale Indicator</span>
                      <span className="v12-kpi-val" style={{ color: colors.accentTeal }}>
                        85,000 Users
                      </span>
                      <span style={{ fontSize: '0.52rem', color: '#6b7280', display: 'block', marginTop: '0.05rem' }}>
                  ...
                  <div className="v12-card-glass" style={{ display: 'flex', alignItems: 'center', gap: '0.8rem', background: '#0e1428' }}>
                    ...
                    <div>
                      <span style={{ fontSize: '0.56rem', color: '#9ca3af', fontWeight: 800, textTransform: 'uppercase', display: 'block' }}>Zero-Trust Identity IAM</span>
                      <span className="v12-kpi-val" style={{ fontSize: '0.98rem', color: '#ffffff', display: 'flex', alignItems: 'center', gap: '0.2rem', marginTop: '0.15rem' }}>
                        🔒 Entra ID Active
                      </span>
                      <span style={{ fontSize: '0.52rem', color: '#9ca3af', display: 'block', marginTop: '0.05rem' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '0.85rem', height: '100%', minHeight: 0 }}>
                  ...
                  <div className="v12-card-glass" style={{ display: 'flex', flexDirection: 'column', gap: '0.45rem', flexShrink: 0, height: '110px' }}>
                    ...
                    <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '0 1rem', background: '#05070e', borderRadius: '6px', border: '1px solid rgba(255,255,255,0.03)', relative: 'relative', overflow: 'hidden' }}>
                      ...
                      <div style={{ textAlign: 'center', background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: '4px', padding: '0.25rem 0.45rem', cursor: 'pointer', zIndex: 5 }} onClick={() => alert("Firefly: Dynamic variant image and text generation based on brief briefs.")}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '0.65rem' }}>
                  ...
                  <div className="v12-card-glass" style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: '0.65rem', background: '#0c1122' }}>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '0.55rem', overflowY: 'auto' }} className="v12-scrollable">
                      ...
                      <div style={{ background: '#04060d', borderRadius: '4px', padding: '0.5rem', fontFamily: 'monospace', fontSize: '0.62rem', border: '1px solid rgba(255,255,255,0.05)' }}>
                        <span style={{ color: '#6b7280' }}>// Symmetrical XMP Metadata Mapping</span><br />
                        <span style={{ color: '#8b5cf6' }}>&lt;rdf:Description</span> rdf:about=""<br />
                        &nbsp;&nbsp;xmlns:novartis="http://ns.novartis.com/gxp/1.0/"&gt;<br />
                        &nbsp;&nbsp;&lt;novartis:Brand&gt;<strong style={{ color: '#14b8a6' }}>"Novartis CMC Operations"</strong>&lt;/novartis:Brand&gt;<br />
                        &nbsp;&nbsp;&lt;novartis:Indication&gt;<strong style={{ color: '#14b8a6' }}>"CSR_V12"</strong>&lt;/novartis:Indication&gt;<br />
                        &nbsp;&nbsp;&lt;novartis:Region&gt;<strong style={{ color: '#14b8a6' }}>"{selectedRegion === 'germany' ? 'EU-DE' : 'US-TX'}"</strong>&lt;/novartis:Region&gt;<br />
                        &nbsp;&nbsp;&lt;novartis:AssetType&gt;<strong style={{ color: '#14b8a6' }}>"CSR Briefing Dossier"</strong>&lt;/novartis:AssetType&gt;<br />
                        &nbsp;&nbsp;&lt;novartis:AIGenerationStatus&gt;<strong style={{ color: '#4ade80' }}>"GxP_Audited_Verified"</strong>&lt;/novartis:AIGenerationStatus&gt;<br />
                        <span style={{ color: '#8b5cf6' }}>&lt;/rdf:Description&gt;</span>
                      </div>

                      <div style={{ background: 'rgba(255,255,255,0.02)', padding: '0.45rem', borderRadius: '4px', border: '1px solid rgba(255,255,255,0.03)' }}>
                        <h4 style={{ margin: 0, fontSize: '0.7rem', fontWeight: 900, color: '#ffffff' }}>System Integration Hooks</h4>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '0.85rem', flex: 1, minHeight: 0 }}>
                ...
                <div className="v12-card-glass" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '0.85rem', padding: '0.6rem 1rem', flexShrink: 0 }}>
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: '1.2rem', flexWrap: 'wrap' }}>
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '0.45rem' }}>
                      <span style={{ fontSize: '0.68rem', fontWeight: 800, color: '#fff' }}>Target State Path:</span>
                      <select
                        value={buyVsBuildSelection}
                        onChange={e => setBuyVsBuildSelection(e.target.value)}
                        style={{ background: '#0c1122', border: '1px solid rgba(255,255,255,0.1)', borderRadius: '4px', fontSize: '0.65rem', color: '#fff', padding: '0.2rem', outline: 'none', cursor: 'pointer', fontWeight: 800 }}
                      >
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0.85rem', flex: 1, minHeight: 0 }}>
                  ...
                  >
                    ...
                    <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: '0.55rem', overflowY: 'auto' }} className="v12-scrollable">
                      ...
                      <div style={{ background: '#05070e', borderRadius: '6px', padding: '0.45rem', border: '1px solid rgba(255,255,255,0.03)', fontSize: '0.65rem' }}>
                        <div style={{ fontWeight: 800, color: '#f59e0b', marginBottom: '0.2rem' }}>Core AWS Components</div>
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '0.15rem', textAlign: 'left', color: '#9ca3af' }}>
                      ...
                      <div style={{ background: '#05070e', borderRadius: '6px', padding: '0.45rem', border: '1px solid rgba(255,255,255,0.03)', fontSize: '0.65rem' }}>
                        ...
                        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0.35rem', textAlign: 'left' }}>
                          <div>• AWS-Veeva Latency: <strong style={{ color: '#fff' }}>450ms</strong></div>
                          <div>• Guardrails False-Positives: <strong style={{ color: '#fff' }}>1.8%</strong></div>
                        </div>
                      </div>
                  ...
                  >
                    ...
                    <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: '0.55rem', overflowY: 'auto' }} className="v12-scrollable">
                      ...
                      <div style={{ background: '#05070e', borderRadius: '6px', padding: '0.45rem', border: '1px solid rgba(255,255,255,0.03)', fontSize: '0.65rem' }}>
                        ...
                        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0.35rem', textAlign: 'left' }}>
                          <div>• MCP Fetch Latency: <strong style={{ color: '#fff' }}>120ms</strong></div>
                          <div>• Model Armor Sanitization: <strong style={{ color: '#fff' }}>22ms</strong></div>
                        </div>
                      </div>
                      ...
                      {siBudgetSlider < 220 ? (
                        ...
                        <div style={{ background: 'rgba(255,255,255,0.01)', padding: '0.45rem', borderRadius: '4px', border: '1px solid rgba(255,255,255,0.03)', fontSize: '0.65rem' }}>
                          <span style={{ fontSize: '0.52rem', color: '#9ca3af', fontWeight: 800, display: 'block' }}>REMEDIATION & FRICTION FLAGS</span>
                          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.15rem', marginTop: '0.2rem', color: '#9ca3af' }}>
            ...
            {reportPage === 'roadmap' && (
              <div style={{ display: 'flex', flexDirection: 'column', gap: '0.85rem', flex: 1, minHeight: 0 }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0.85rem', flexShrink: 0 }}>
                  ...
                  <div className="v12-card-glass" style={{ display: 'flex', flexDirection: 'column', gap: '0.45rem', background: '#0e1428' }}>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '0.35rem', fontSize: '0.65rem', color: '#cbd5e1' }}>
                      <div>• <strong style={{ color: '#fff' }}>Microsoft 365 SharePoint</strong>: Seamless injection of audited AI-reviewed drafts directly into SharePoint GxP repositories.</div>
                      <div>• <strong style={{ color: '#fff' }}>Microsoft Teams Webhooks</strong>: Event-driven alerts and instant agent-to-human escalation channels when MLR exceptions are flagged.</div>
                    </div>
                  </div>
                  ...
                  <div className="v12-card-glass" style={{ display: 'flex', flexDirection: 'column', gap: '0.45rem', background: '#0e1428' }}>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '0.35rem', fontSize: '0.65rem', color: '#cbd5e1' }}>
                      <div>• <strong style={{ color: '#fff' }}>Microsoft Entra ID SSO</strong>: Secure Azure AD token exchange managed natively via Kong AI security gateways.</div>
                      <div>• <strong style={{ color: '#fff' }}>Granular RBAC Contracts</strong>: Cryptographic identity propagation verified on every single tool execution call.</div>
                    </div>
                  </div>
            ...
            {reportPage === 'gxp_validation' && (
              <div style={{ display: 'grid', gridTemplateColumns: '1.3fr 1fr', gap: '0.85rem', flex: 1, minHeight: 0 }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '0.85rem', height: '100%', minHeight: 0 }}>
                  ...
                  <div className="v12-card-glass" style={{ flex: 1.2, display: 'flex', flexDirection: 'column', gap: '0.45rem', background: '#0c1122' }}>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '0.45rem', overflowY: 'auto' }} className="v12-scrollable">
                      <div style={{ background: '#05070e', borderRadius: '6px', padding: '0.4rem', border: '1px solid rgba(255,255,255,0.03)' }}>
                        <h4 style={{ margin: 0, fontSize: '0.68rem', fontWeight: 900, color: colors.accentTeal }}>Google Vertex Model Armor</h4>
                        <span style={{ fontSize: '0.58rem', color: '#cbd5e1', display: 'block', marginTop: '0.1rem', lineHeight: 1.3 }}>
                  ...
                  <div className="v12-card-glass" style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: '0.45rem', background: 'rgba(20, 184, 166, 0.03)', border: `1.2px solid ${colors.accentTeal}` }}>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '0.35rem', fontSize: '0.62rem', color: '#cbd5e1', lineHeight: 1.35 }}>
                      <div>• <strong style={{ color: '#fff' }}>Primary Risk</strong>: Foundation model endpoint failure or regional cloud outage.</div>
                      <div>• <strong style={{ color: '#fff' }}>Mitigation Action</strong>: Active-active cross-region failover between GCP US-East (Virginia) and GCP US-Central (Iowa).</div>
                      <div>• <strong style={{ color: '#fff' }}>Success Metric</strong>: **RTO &lt; 4 minutes** with zero session data loss during active MLR reviews.</div>
                    </div>
                  </div>
...
print("🎉 Successfully deployed ultimate McKinsey-grade C-Suite telemetry and GxP validation perimeters!")

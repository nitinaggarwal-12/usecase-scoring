...
export default function App() {
  ...
  useEffect(() => {
    const handleHashChange = () => {
      ...
      const validRoutes = [
        ...
        'framework-interactive', 'fde-model', 'architecture-canvas', 'maturity-assessor', 'maturity-report', 'agentic-discovery', 'agentic-report', 'unified-assessment', 'premium-assessor', 'portfolio-intelligence-v10'
      ];
  ...
  useEffect(() => {
    if ((activeFramework === 'option5' || activeFramework === 'option6' || activeFramework === 'option7') && !activeSessionId) {
      const prefix = activeFramework === 'option7' ? 'v7_' : '';
      ...
      <div className="app-main-viewport">
        ...
        <main className="main-content" style={activeFramework === 'option10' ? { padding: 0, margin: 0, maxWidth: '100%' } : undefined}>
          {viewMode === 'permissions' ? (
            ...
            />
          ) : (viewMode === 'landing' && ['option5', 'option6', 'option7', 'option8', 'option9', 'intake'].includes(activeFramework)) ? (
            <AssessmentLanding
              framework={activeFramework}
              onStart={() => {
